                            ...
                            <div className='group rounded-xl bg-card p-[25px]'>
                                ...
                                <div>
                                    <NavLink to={'/blog-detail/'}>
                                        <h2 className='mt-[12px] text-[20px] font-semibold transition-all duration-300 hover:text-theme md:text-[24px]'>Build an awesome developer portfolio website.</h2>
                                    </NavLink>
